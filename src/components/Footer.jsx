  ...
  render() {
    ...
    return (
      <>
            ...
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
              <div class="space-y-8">
                ...
                <p class="text-sm leading-6 text-gray-600">
                  ساخته و پرداخته شده با عشق به دانش و گسترش اندیشه انتقادی –
                  تیم طراحی ایران آکادمیا
                </p>
        ...
        <div class="bg-gray-900" style="direction: ltr;">
          <div
            class="
      max-w-7xl
      mx-auto
          ...
          >
            <div class="flex justify-center space-x-6 md:order-2">
              <a
                ...
                class="text-gray-400 hover:text-gray-500"
              >
                <span class="sr-only">Cubite</span>
                <img
                  class="h-16"
            ...
            <div class="mt-8 md:mt-0 md:order-1">
              <p class="text-center text-base text-gray-400">
                edX, Open edX and the edX and Open edX logos are trademarks or
